...
Command.prototype.invoke = function invoke(args, opts) {
  ...
  try {
    ...
    if (e instanceof Command.UsageError) {
      ...
      self.logError('[-] You must be in an maka project to run this command.');
      self.logNotice('Type "maka help" for maka commands.');
      self.logNotice('You may create a new application by typing\n maka create MyApp\n\n');
      self.logNotice('For more information visit:\n https://www.maka-cli.org\n ' +
        'https://medium.com/@matthewjmcampbell\n https://gitter.im/meteor/meteor (@maka-io) \n');
      //Maka.logUsage();
    } else {
      throw e;
    }
