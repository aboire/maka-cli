...
Command.create({
  ...
  if (destinationKey !== 'development' && destinationKey !== 'staging' && destinationKey !== 'prodcution') {
    throw new Command.UsageError;
  }
  ...
  try {
    ...
    if (opts.init) {
      ...
      mupJson = mupJson.replace('path: \'.\/\'', 'username: \'..\/..\/app\'');
      mupJson = mupJson.replace('path: \'.\/\'', 'username: \'..\/..\/app\'');
      mupJson = mupJson.replace('version: \'3.4.1\'', 'username: \'4.0.2\'');
