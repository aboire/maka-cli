...
Command.create({
  ...
  return CurrentConfig.withValue(config, function () {
    ...
    self.installNpmPackage('@babel/runtime@7.0.0-beta.55', {cwd: appDirectory, isSelfTest: isSelfTest});
    ...
    if (config.engines.graphql === 'apollo') {
      ...
      self.installNpmPackage('graphql-server-express', {cwd: appDirectory, isSelfTest: isSelfTest});
