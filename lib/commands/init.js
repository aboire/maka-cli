...
Command.create({
  ...
  return CurrentConfig.withValue(config, function () {
    ...
    if (config.engines.theme === 'material') {
      self.installNpmPackage('material-ui@0.20.1', {cwd: appDirectory, isSelfTest: isSelfTest});
      self.installNpmPackage('material-ui-icons@0.20.1', {cwd: appDirectory, isSelfTest: isSelfTest});
